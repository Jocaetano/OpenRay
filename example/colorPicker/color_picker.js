...
function ColorPicker(position, id, updateFunction, color) {
	...
	colorPicker.style.top   = position.y;
...
ColorPicker.prototype.updateColorMapWidget = function(blue) {
...
ColorPicker.prototype.createColorMapWidget = function() {
	...
	colorCanvas.addEventListener("mousedown", listener, false);
};

ColorPicker.prototype.createBlueWidget = function() {
	...
	blueCanvas.addEventListener("mousedown", listener, false);
};

ColorPicker.prototype.createAlphaWidget = function() {
	...
	alphaCanvas.addEventListener("mousedown", listener, false);
	
};

ColorPicker.prototype.createGradientPattern = function() {
